...
def ltl_compilation_client(system, goals, initial_conditions,
                           sm_outcomes, custom_ltl = None):
    '''Client'''
    ...
    try:
        ...
        response = ltl_compilation_srv(system, goals,
                                       initial_conditions, sm_outcomes)
